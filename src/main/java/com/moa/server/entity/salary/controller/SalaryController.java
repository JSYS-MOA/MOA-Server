...
public class SalaryController {
    ...
    @DeleteMapping({"/{transactionId}", "/payrolls/{transactionId}"})
    public void deletePayroll(@PathVariable Integer transactionId) {
        payrollService.transactionSalaryDelete(transactionId);
    }
}
